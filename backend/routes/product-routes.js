...
import { createProduct, updateProduct, deleteProduct, fetchProducts, fetchProductById, fetchAllProducts, addProductReviews, fetchTopProducts, fetchNewProducts, fetchRelatedProducts, fetchFilteredProducts} from "../controllers/product-controllers.js";
...
router.route("/filtered-products").post(fetchFilteredProducts)
router
.route("/:productId")
